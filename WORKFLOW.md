...
| Obsidian | 人類知識與決策 | 依專案 | 收工或明確任務 | 依 policy |
| Notion | 指定頁面或資料庫 | 可選 | 明確要求才可 | 每次寫入 |
...
長篇決策移至 Git 歷史或 Obsidian。輸入、版本或權限變更後，重新檢查受影響的 SOP 與 ReadyGate 閘門。
